  ...
  events: [
    {
      ...
      description: "On February 22, 2025, I Had The Privilege Of Being A Panel Speaker On 'Leadership & Soft Skills' At Job Fest 'চাকরি মেলা ২০২৫' Organized By Daff...",
    ...
    },
    {
      ...
      description: "দেশের আইটি খাতের ১৬০ জন আইটি প্রফেশনালকে বিশ্বমানের দক্ষতা উন্নয়ন প্রশিক্ষণ দেওয়া হয়েছে। ...",
      linkText: "Read On Facebook",
    },
  ],
  social: [
    {
      ...
      description: "Working With Fresh Graduates To Prepare Them For The Tech Industry Is A Crucial Step Toward Driving Nationwide Growth. At Goinnovior Li...",
      linkText: "Read On Facebook",
    },
    {
    ...
    <section className="py-24 bg-white overflow-hidden">
      <div className="container mx-auto">
          ...
          {categories.map((category, index) => (
            <React.Fragment key={category.id}>
              ...
              {index < categories.length - 1 && (
                <span className="text-black/10 font-fragment-mono text-[22px] hidden md:block mb-4">
                  /
                </span>
              )}
            </React.Fragment>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {solutionsData[activeTab as keyof typeof solutionsData].map((item, index) => (
              <div key={index} className="group cursor-pointer">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex gap-2">
                    {item.tags.map((tag, i) => (
                      <span key={i} className="text-[14px] font-poppins text-black/40">
                  ...
                  <div className="flex items-center gap-2 text-black/40">
                    ...
                    <span className="text-[12px] md:text-[14px] font-poppins">{item.date}</span>
                  </div>
                </div>

                <h3 className="text-[20px] md:text-[28px] font-poppins font-semibold text-[#333] mb-4 leading-tight group-hover:text-[#9747FF] transition-colors">
                  {item.title}
                </h3>
                
                <p className="text-[14px] md:text-[16px] font-plus-jakarta text-black/50 leading-relaxed mb-6">
                  {item.description}
                </p>

                <div className="flex items-center gap-2 text-black font-semibold text-[14px] md:text-[16px] hover:gap-3 transition-all">
                  {item.linkText} 
